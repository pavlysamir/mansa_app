...
import 'package:mansa_app/core/functions/once_future_builder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: OnceFutureBuilder(future: () async {
          ...
          // await profileCubit!.getAddressGovernment(3);
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          profileCubit?.categoryData.length == 0
                              ? const SizedBox()
                              : Padding(
                                  padding:
...
// ProfileCubit? profileCubit;
  ...
  //   await profileCubit!.getProfileData();
  //   profileCubit!.getAddressGovernment(
  //       profileCubit!.myProfileData!.responseData.profileData.governorateId);
