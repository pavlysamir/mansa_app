              ...
              children: [
                ...
                CustomUserdataRow(
                    isNull: myProfileData?.profileData.districtId == 0 &&
                            myProfileData?.profileData.governorateId == 0 &&
                            myProfileData?.profileData.address == null
                        ? true
                        : false,
                    ...
                    text: myProfileData?.profileData.districtId == 0 &&
                            ...
                            myProfileData?.profileData.address == null
                        ? 'العنوان'
                        : '${myProfileData?.profileData.address} ${ProfileCubit.get(context)!.getAddressGovernment(myProfileData?.profileData.governorateId)} ,${ProfileCubit.get(context)!.getAddressDistric(3)}'
                    //myProfileData.profileData.address ?? 'عنوان  '
                    ),
                // myProfileData?.profileData.specializationFields.length == 0
                //     ? const SizedBox()
                //     :
                CustomUserdataRow(
                  isNull:
                ...
                CustomUserdataRow(
                  isNull: myProfileData?.profileData.mobileNo == null
                      ? true
                      : false,
                  img: AssetsData.call,
